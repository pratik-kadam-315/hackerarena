...
function Learning() {
    ...
    useEffect(() => {
        // Particle Background (matching Home.jsx)
    ...
    return (
        <div className="learning-wrapper">
            ...
            <header className="learning-hero">
                ...
                <h1 className="learning-title">Interactive <em>Anatomy</em></h1>
                <p className="learning-subtitle">
                    Select a section or scan the body to explore high-fidelity AR models
                    with real-time anatomical descriptions.
                </p>
